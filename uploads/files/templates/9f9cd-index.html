      ...
      <div class="catalog-showcase">
		<ul>
            <li class="catalog-item" id="44">
                ...
                <div class="tab">
                  <p class="product-destiny promotion">Desde <span>1,289 USD**</span></p>
