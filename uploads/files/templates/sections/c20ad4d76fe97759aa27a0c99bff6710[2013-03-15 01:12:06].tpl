     ...
     <html xmlns="http://www.w3.org/1999/xhtml">
         <head>
             ...
             <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/uploads/files/resources/css/ba378-base.css" />
             <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>uploads/files/resources/css//2cdb5-showcase.css" />
     ...
     <div class="wrap">
           ...
           <div class="catalog-showcase">
             <ul>
                 {%start-loop structure='c20ad4d76fe97759aa27a0c99bff6710'%}             <li class="catalog-item" id="{%element.entryContentsId structureId='c20ad4d76fe97759aa27a0c99bff6710' fieldId='d645920e395fedad7bbbed0eca3fe2e0'%}">
                     <div class="product-banner" rel="1">
                       ...
                       <a rel="1" href="#" class="product-shutter">
                             <img src="<?php echo base_url(); ?>{%element.imagen structureId='c20ad4d76fe97759aa27a0c99bff6710' fieldId='d67d8ab4f4c10bf22aa353e27879133c'%}" alt="" />
                       </a> 
                       <!-- Promocion -->
                     ...
                     <div class="tab">
                       <p class="product-destiny promotion">Desde <span>{%element.precio structureId='c20ad4d76fe97759aa27a0c99bff6710' fieldId='a1d0c6e83f027327d8461063f4ac58a6'%}</span></p>
