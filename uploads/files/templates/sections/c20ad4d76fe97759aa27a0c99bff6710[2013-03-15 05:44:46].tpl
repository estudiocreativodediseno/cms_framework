  ...
  <link rel="stylesheet" type="text/css" href="css/base.css" />
         ...
         <div class="wrap">
               ...
               <div class="catalog-showcase">
                 <ul>
                     {%start-loop structure='c20ad4d76fe97759aa27a0c99bff6710'%}             <li class="catalog-item" id="{%elementId%}">
                         ...
                         <div class="tab">
                           <p class="product-destiny promotion"><span>{%element.precio structureId='a1d0c6e83f027327d8461063f4ac58a6' fieldId='d645920e395fedad7bbbed0eca3fe2e0'%}</span></p>
