              ...
              framework statament[startloop]
                  framework statament[element.fieldName]
              framework statament[endloop] tester2222
                        <!-- asdasd a --> 
                       ...framework statament[startloop]...framework statament[stdddartloop]
                        {start-loop name='algo'}
                  test
                      framework statament[element.fieldName]
                  framework statament[endloop]
                   Agregando 1
                       {element.fieldName}
