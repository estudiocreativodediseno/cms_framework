              ...
              framework statament[0start-loop objectName='objectName' maxRows='' rowsPerPage=''%}
]
                  framework statament[0element.fieldName]
              framework statament[0end-loop] tester2222
                        <!-- asdasd a --> 
                       ...framework statament[0start-loop name='algo'%}...framework statament[0start-l]...framew]l]
                        {start-loop name='algo'}
                  test
                      framework statament[0element.fieldName]
                  framework statament[0end-loop]
                   Agregando 1
                       {element.fieldName}
