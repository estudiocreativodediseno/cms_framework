              ...
              framework statament[18start-loop objectName='objectName' maxRows='' rowsPerPage=''%}]
                  framework statament[19element.fieldName%}]
              framework statament[16end-loop%}] tester2222
                        <!-- asdasd a --> 
                       ...framework statament[26start-loop name='algo'%}]...framework statament[26start-loop name='algo'%}]
                        {start-loop name='algo'}
                  test
                      framework statament[23element.fieldName%}]
                  framework statament[19end-loop%}]
                   Agregando 1
                       {element.fieldName}
                   {start-loop objectName='objectName' maxRows='' rowsPerPage=''}
                   {end-loop}
                    ...
                    Agregando If-Else
                        ...
                        Agregando WhileAgregando WhileAgregando While           <meta name="format-detection" content="telephone=no" />
                                    <title>CRUCEROS VIAJES PALACIO | Los mejores cruceros del mundo</title>
                  framework statament[22start-loop objectName='objectName' maxRows='' rowsPerPage=''%}]
                            </head>
                        Agregando If-ElseAgregando If-ElseAgregando If-Else    
                            <body>
                                <div class="wrap">
