  ...
  <link rel="stylesheet" type="text/css" href="css/base.css" />
         ...
         <div class="wrap">
               ...
               <div class="catalog-showcase">
                 <ul>
                     <?php foreach($cruceros_elements as $cruceros_element): ?>             <li class="catalog-item" id="<?php echo $categorías_element["id"]; ?>">
                         ...
                         <div class="tab">
                           <p class="product-destiny promotion"><span><?php echo $_element[$fieldTags->precio]["data"]; ?></span></p>
