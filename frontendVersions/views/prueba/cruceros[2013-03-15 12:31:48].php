    ...
    <div class="wrap">
          ...
          <div class="catalog-showcase">
            <ul>
                <?php echo json_encode($cruceros_elements); foreach($cruceros_elements as $cruceros_element): ?>             

                <li class="catalog-item" id="<?php echo $cruceros_element->entryContentsId; ?>">
