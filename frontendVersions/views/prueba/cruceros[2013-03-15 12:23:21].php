    ...
    <div class="wrap">
          ...
          <div class="catalog-showcase">
            <ul>
                <?php  foreach($cruceros_elements as $cruceros_element): echo json_encode($cruceros_element).'<hr>'; ?>             


                  <li class="catalog-item" id="<?php echo $cruceros_element->{$fieldTags->entryContentsId}; ?>">
