     ...
     <div class="wrap">
           ...
           <div class="catalog-showcase">
             <ul>
                 <?php foreach($cruceros_elements as $cruceros_element): ?>         <li class="catalog-item" id="<?php echo $cruceros_element->entryContentsId; ?>">
                     <div class="product-banner" rel="1">
                       ...
                       <a rel="1" href="#" class="product-shutter">
                             <img src="<?php echo $cruceros_element[$fieldTags->image]['data']; ?>" alt="" />
                       </a> 
                       <!-- Promocion -->
