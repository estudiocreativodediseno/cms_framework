 ...
 <div class="wrap">
       ...
       <div class="catalog-showcase">
         <ul>
             <?php foreach($c20ad4d76fe97759aa27a0c99bff6710s as $element): ?>             <li class="catalog-item" id="<?php $element->entryContentsId; ?>">
                 <div class="product-banner" rel="1">
                   <h2 class="product-tag">
                       <?php $element->nombre; ?><br />
                       <span><?php $element->lugar; ?></span>
                   </h2>
                   <a rel="1" href="#" class="product-shutter">
                         <img src="<?php $element->imagen; ?>" alt="" />
                   </a> 
                   <!-- Promocion -->
                 ...
                 <div class="tab">
                   <p class="product-destiny promotion">Desde <span><?php $element->precio; ?></span></p>
