                 ...
                 <?php foreach($cruceros_elements as $cruceros_element): ?>             <li class="catalog-item" id="<?php echo $cruceros_element[$fieldTags->entryContentsId]["data"]; ?>">
                     <div class="product-banner" rel="1">
                       ...
                       <a rel="1" href="#" class="product-shutter">
                             <img src="<?php echo base_url(); ?><?php echo $cruceros_element[$fieldTags->imagen]["data"]; ?>" alt="" />
                       </a> 
                       <!-- Promocion -->
                     ...
                     <div class="tab">
                       <p class="product-destiny promotion">Desde <span><?php echo $cruceros_element[$fieldTags->precio]["data"]; ?></span></p>
