              ...
              framework statament[start-loop objec]
                  framework statament[element.fieldName%}
]
              framework statament[end-loop%} teste] tester2222
                        <!-- asdasd a --> 
                       ...framework statament[start-loop name='algo'%}...{]...framework statament[start-loop name='algo'%}...{]
                        {start-loop name='algo'}
                  test
                      framework statament[element.fieldName%}
]
                  framework statament[end-loop%}
]
                   Agregando 1
                       {element.fieldName}
                  ...
                  framework statament[start-loop objectNam]
                            </head>
