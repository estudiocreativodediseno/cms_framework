...
74-12[{%start-loop objectName='objectName' maxRows='' rowsPerPage=''%}
]\n35-16[{%element.fieldName%}
]\n22-12[{%end-loop%} tester2222]\n                      <!-- asdasd a --> 
48-24[{%start-loop name='algo'%}...
]\n                      {start-loop name='algo'}
                test
39-20[{%element.fieldName%}
]\n26-16[{%end-loop%}
]\n                 Agregando 1
                     {element.fieldName}
...
78-16[{%start-loop objectName='objectName' maxRows='' rowsPerPage=''%}
]\n                          </head>
