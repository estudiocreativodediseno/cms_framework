...
class Cruceros extends CI_Controller {			
    ...
    function __construct(){
  	...
  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [2013-03-15 12:19:22]
     ...
     function index(){
		try{
        	...
        	//inicia function_index_code
						...
						$fieldTags->entryContentsId = "d645920e395fedad7bbbed0eca3fe2e0"  			$fieldTags->nombre = "d645920e395fedad7bbbed0eca3fe2e0"  			$fieldTags->lugar = "d645920e395fedad7bbbed0eca3fe2e0"  			$fieldTags->imagen = "d645920e395fedad7bbbed0eca3fe2e0"  			$fieldTags->precio = "d645920e395fedad7bbbed0eca3fe2e0"  /*No se reconoció la instrucción: endloop*/
