...
class Cruceros extends CI_Controller {			
    ...
    function __construct(){
  	...
  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [2013-03-15 06:03:11]
     ...
     function index(){
		try{
        	...
        	//inicia function_index_code
              /*No se reconoció la instrucción: insertlibraries*/
						...
						foreach ($rs_contents->result() as $row){
							...
							array_push($output->cruceros_elements,array("id",$row->entryContentsId));
						}
			/*No se reconoció la instrucción: elementId*/
			  						$fieldTags->nombre = "d645920e395fedad7bbbed0eca3fe2e0";
  						$fieldTags->lugar = "3416a75f4cea9109507cacd8e2f2aefc";
  						$fieldTags->imagen = "d67d8ab4f4c10bf22aa353e27879133c";
  						$fieldTags->precio = "a1d0c6e83f027327d8461063f4ac58a6";
  /*No se reconoció la instrucción: endloop*/
			
        	//termina function_index_code
	
			$output->fieldTags = $fieldTags;
			$output->title = 'Cruceros - Catalogo de Cruceros';
