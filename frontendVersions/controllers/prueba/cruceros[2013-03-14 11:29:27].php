...
class {Cruceros} extends CI_Controller {			
    ...
    function __construct(){
  	...
  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [{2013-03-14 11:28:22}]
	 ...
	 */
     function index(){
		try{
			...
			%element%  %element%  %element%  %element%  %element%  %endloop%}
	 ...
	 */
     function id($valueId){
		try{
            ...
            {  <?php foreach($cruceros_elements as $cruceros_element): ?>%element%  %element%  %element%  %element%  %element%  %endloop%}
	 ...
	 */
     function page($page){
		try{
            ...
            {  %startloop%%element%  %element%  %element%  %element%  %element%  %endloop%}
