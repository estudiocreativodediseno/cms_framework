...
class {Cruceros} extends CI_Controller {			
    ...
    function __construct(){
  	...
  	/**
     * Código generado automáticamente por CMS-FRAMEWORK [{2013-03-14 11:32:56}]
	 ...
	 */
     function index(){
		try{
			...
			/*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: endloop*/}
	 ...
	 */
     function id($valueId){
		try{
            ...
            {  /*No se reconoció la instrucción: startloop*//*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: element*/  /*No se reconoció la instrucción: endloop*/}
